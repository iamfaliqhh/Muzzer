...
if (!empty($_POST['install'])) {
    ...
    if (empty($ServerErrors)) {
        ...
        $file_content =
            '<?php
// +------------------------------------------------------------------------+
// | @author Faliqh (itsfaliqhh)
// | @author_url 1: http://www.github.com/iamfaliqhh
// | @author_url 2: http://codecanyon.net/user/doughouzforest
// | @author_email: faliqhyoon@outlook.com
// +------------------------------------------------------------------------+
// | Muzzer Stream - The Music Streaming Platform
// | Copyright (c) 2023 Muzzer. All rights reserved.
// +------------------------------------------------------------------------+
// MySQL Hostname
...
?>';
        ...
        if ($config_file) {
            ...
            if ($query) {
                ...
                $success = 'Muzzer Stream successfully installed, please wait ..';
...
<head>
    ...
    <title>Muzzer Stream | Installation</title>
...
if (!file_exists('../muzzerstream.sql')) {
    $is_sql = false;
    $disabled = true;
}
                    ...
                    <div>
                        ...
                        <div class="setting-well">
                                ...
                                <div class="req">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>muzzerstream.sql</td>
                                                <td>Required muzzerstream.sql for the installation <small>(Located in ./Muzzer)</small></td>
                            ...
                            <?php } else if ($page == 'finish') { ?>
                                <div class="req">
                                    <p>Congratulations! Muzzer script has been successfully installed and your website is ready.</p>
                                ...
                                <div class="req">
                                    ...
                                    <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        ...
                                        <div class="form-group last-btn">
                                            ...
                                            <div class="col-md-8">
                                                <button type="submit" onclick="SubmitButton();" class="btn btn-main" <?php echo ($disabled == true) ? 'disabled' : ''; ?>>Install <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="19" height="19">
